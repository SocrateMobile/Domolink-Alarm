            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(CONF_FAILOVER_GSM_ENABLED, default=DEFAULT_FAILOVER_GSM_ENABLED): bool,
                    vol.Optional(CONF_FAILOVER_GSM_SERVICE, default=""): str,
                    vol.Optional(CONF_FAILOVER_LOCAL_ALARM, default=DEFAULT_FAILOVER_LOCAL_ALARM): bool,
                    vol.Optional(CONF_DETERRENCE_ENABLED, default=DEFAULT_DETERRENCE_ENABLED): bool,
                    vol.Optional(CONF_TTS_VOLUME_ALERT, default=DEFAULT_TTS_VOLUME_ALERT): selector.NumberSelector(
                        selector.NumberSelectorConfig(min=0.1, max=1.0, step=0.1, mode=selector.NumberSelectorMode.SLIDER)
                    ),
                    vol.Optional(CONF_KEYPAD_ENABLED, default=DEFAULT_KEYPAD_ENABLED): bool,
                    vol.Optional(CONF_KEYPAD_BEEP_ENTRY, default=DEFAULT_KEYPAD_BEEP_ENTRY): bool,
                    vol.Optional(CONF_KEYPAD_BEEP_EXIT, default=DEFAULT_KEYPAD_BEEP_EXIT): bool,
                }
            ),
        )
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(CONF_PROXIMITY_SENSOR, default=""): selector.EntitySelector(
                        selector.EntitySelectorConfig(domain="proximity")
                    ),
                    vol.Optional(CONF_GEOFENCE_APPROACH_REMINDER, default=DEFAULT_GEOFENCE_APPROACH_REMINDER): bool,
                    vol.Optional(CONF_GEOFENCE_APPROACH_DISTANCE, default=DEFAULT_GEOFENCE_APPROACH_DISTANCE): int,
                    ...
                    vol.Optional(CONF_NF_A2P_MODE, default=DEFAULT_NF_A2P_MODE): bool,
                    vol.Optional(CONF_NF_A2P_WINDOW, default=DEFAULT_NF_A2P_WINDOW): int,
                    vol.Optional(CONF_NF_A2P_STRICT_DISTINCT, default=DEFAULT_NF_A2P_STRICT_DISTINCT): bool,
                    vol.Optional(CONF_NF_A2P_PRE_ALERT_CHIME, default=DEFAULT_NF_A2P_PRE_ALERT_CHIME): bool,
                    vol.Optional(CONF_USERS_PROFILES, default=""): str,
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(CONF_FTP_PROTOCOL, default=DEFAULT_FTP_PROTOCOL): vol.In(FTP_PROTOCOLS),
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(CONF_FAILOVER_GSM_ENABLED, default=self.options.get(CONF_FAILOVER_GSM_ENABLED, DEFAULT_FAILOVER_GSM_ENABLED)): bool,
                    vol.Optional(CONF_FAILOVER_GSM_SERVICE, default=self.options.get(CONF_FAILOVER_GSM_SERVICE, "")): str,
                    vol.Optional(CONF_FAILOVER_LOCAL_ALARM, default=self.options.get(CONF_FAILOVER_LOCAL_ALARM, DEFAULT_FAILOVER_LOCAL_ALARM)): bool,
                    vol.Optional(CONF_DETERRENCE_ENABLED, default=self.options.get(CONF_DETERRENCE_ENABLED, DEFAULT_DETERRENCE_ENABLED)): bool,
                    vol.Optional(CONF_TTS_VOLUME_ALERT, default=self.options.get(CONF_TTS_VOLUME_ALERT, DEFAULT_TTS_VOLUME_ALERT)): selector.NumberSelector(
                        selector.NumberSelectorConfig(min=0.1, max=1.0, step=0.1, mode=selector.NumberSelectorMode.SLIDER)
                    ),
                    vol.Optional(CONF_KEYPAD_ENABLED, default=self.options.get(CONF_KEYPAD_ENABLED, DEFAULT_KEYPAD_ENABLED)): bool,
                    vol.Optional(CONF_KEYPAD_BEEP_ENTRY, default=self.options.get(CONF_KEYPAD_BEEP_ENTRY, DEFAULT_KEYPAD_BEEP_ENTRY)): bool,
                    vol.Optional(CONF_KEYPAD_BEEP_EXIT, default=self.options.get(CONF_KEYPAD_BEEP_EXIT, DEFAULT_KEYPAD_BEEP_EXIT)): bool,
                }
            ),
        )
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(CONF_PROXIMITY_SENSOR, default=self.options.get(CONF_PROXIMITY_SENSOR, "")): selector.EntitySelector(
                        selector.EntitySelectorConfig(domain="proximity")
                    ),
                    vol.Optional(CONF_GEOFENCE_APPROACH_REMINDER, default=self.options.get(CONF_GEOFENCE_APPROACH_REMINDER, DEFAULT_GEOFENCE_APPROACH_REMINDER)): bool,
                    vol.Optional(CONF_GEOFENCE_APPROACH_DISTANCE, default=self.options.get(CONF_GEOFENCE_APPROACH_DISTANCE, DEFAULT_GEOFENCE_APPROACH_DISTANCE)): int,
                    ...
                    vol.Optional(CONF_NF_A2P_MODE, default=self.options.get(CONF_NF_A2P_MODE, DEFAULT_NF_A2P_MODE)): bool,
                    vol.Optional(CONF_NF_A2P_WINDOW, default=self.options.get(CONF_NF_A2P_WINDOW, DEFAULT_NF_A2P_WINDOW)): int,
                    vol.Optional(CONF_NF_A2P_STRICT_DISTINCT, default=self.options.get(CONF_NF_A2P_STRICT_DISTINCT, DEFAULT_NF_A2P_STRICT_DISTINCT)): bool,
                    vol.Optional(CONF_NF_A2P_PRE_ALERT_CHIME, default=self.options.get(CONF_NF_A2P_PRE_ALERT_CHIME, DEFAULT_NF_A2P_PRE_ALERT_CHIME)): bool,
                    vol.Optional(CONF_USERS_PROFILES, default=self.options.get(CONF_USERS_PROFILES, "")): str,
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(CONF_FTP_PROTOCOL, default=self.options.get(CONF_FTP_PROTOCOL, DEFAULT_FTP_PROTOCOL)): vol.In(FTP_PROTOCOLS),
