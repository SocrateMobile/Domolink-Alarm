...
REPO_NAME = "Domolink-Alarm"
GITHUB_REPO = f"{REPO_OWNER}/{REPO_NAME}"

ROOT_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
MANIFEST_PATH = os.path.join(ROOT_DIR, "custom_components", "domolink_alarm", "manifest.json")
CONST_PATH = os.path.join(ROOT_DIR, "custom_components", "domolink_alarm", "const.py")
...
def create_github_release(new_ver: str, release_notes: str, token: str) -> None:
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Domolink-Alarm-Releaser",
        },
        method="POST",
    )
